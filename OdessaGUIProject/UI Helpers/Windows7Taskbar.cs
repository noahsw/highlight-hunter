...
namespace OdessaGUIProject
{
    ...
    {
        private static readonly OperatingSystem OperatingSystemInfo = Environment.OSVersion;
        ...
        internal static bool Windows7OrGreater
        {
            get
            {
                return (OperatingSystemInfo.Version.Major == 6 && OperatingSystemInfo.Version.Minor >= 1)
                    || (OperatingSystemInfo.Version.Major > 6);
            }
        }
