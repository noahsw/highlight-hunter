...
{
    internal static class DNA
    {
        public const int ERR_ACTIVATION_EXCEEDED_MU = 21;

        public const int ERR_ACTIVATION_EXPECTED = 8;

        public const int ERR_ACTIVATION_EXPECTED_MU = 19;
        ...
        public const int ERR_REACTIVATION_EXPECTED_MU = 20;
        ...
        public static string MD5File(string dllPathName)
        {
            ...
            {
                var fs = new FileStream(dllPathName, FileMode.Open, FileAccess.Read);
                MD5 md5 = new MD5CryptoServiceProvider();
                byte[] md5Result = md5.ComputeHash(fs);
                fs.Close();
