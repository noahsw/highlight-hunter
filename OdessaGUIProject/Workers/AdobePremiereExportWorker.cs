...
{
    internal class AdobePremiereExportWorker : AbstractExportWorker
    {
        private static readonly Logger Logger = LogManager.GetCurrentClassLogger();

        internal override string AppName
        {
            get { return "Adobe Premiere"; }
        }
...
");
        ...
        {
            return "Adobe Premiere XML (*.xml)|*.xml|All Files (*.*)|*.*";
        }
        ...
        private bool CalculateIsNTSC(double framesPerSecond)
