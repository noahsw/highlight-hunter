						...
						?>
											...
											?>
															<div class="one_fourth<?php echo $last_class?>" style="margin-right:2%;margin-top:-20px">
																<a href="<?php echo $permalink_url; ?>" class="one_fourth_detail_img">
																	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=370&w=350&zc=1" alt="" class="show_detail"/>
																	<div class="one_fourth_detail_div">
																		<h5 class="cufon"><?php echo $portfolio_item->post_title?></h5>
																		<div class="post_detail">
																			date: <?php echo date('d M Y', strtotime($portfolio_item->post_date)); ?>
																		</div>
																		<br/>
																		<span>
																			<?php echo pp_substr(strip_tags(strip_shortcodes($portfolio_item->post_content)), 370); ?>																	
																		</span>
																	</div>
																</a>
															</div>
