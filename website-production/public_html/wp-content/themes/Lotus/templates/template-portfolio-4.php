...
?>	
						...
						?>
											...
											?>
															<div class="one_fourth<?php echo $last_class?>" style="margin-right:2%">
																<a title="<?php echo $portfolio_item->post_title?>" href="<?php echo $permalink_url; ?>" class="one_fourth_normal">
																	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=120&w=190&zc=1" alt="" class="img_nofade"/>
																</a>
																...
																<div class="portfolio_desc">
																	...
																	<span>
																	<?php echo pp_substr(strip_tags(strip_shortcodes($portfolio_item->post_content)), 50); ?>																	
																	</span>
																</div>
															</div>
