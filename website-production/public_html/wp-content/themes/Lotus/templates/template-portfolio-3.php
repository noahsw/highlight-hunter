...
?>	
						...
						?>
											...
											?>
															<div class="one_third<?php echo $last_class?>" style="margin-right:3%">
																<a title="<?php echo $portfolio_item->post_title?>" href="<?php echo $permalink_url; ?>" class="one_third_img">
